...
const FIELD_SPEC = `{
  ...
  "categoria": "caminho completo da categoria na Olist/Tiny, ex: 'Casa > Organização > Suportes'",
  "categoriaMercadoLivre": "caminho da categoria oficial do Mercado Livre mais próxima",
  "categoriaShopee": "caminho da categoria oficial da Shopee mais próxima",
  "tags": ["até 10 tags curtas de busca, sem #"],
